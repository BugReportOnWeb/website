        ...
        <div className='flex flex-col mx-3 mt-64 max-w-[40rem] pb-7 justify-center items-center gap-5 sm:flex-row-reverse sm:items-start sm:mt-0 sm:pb-0'>
            ...
            <div className='sm:w-3/4'>
                ...
                <div className='mt-7 text-xs flex flex-col justify-around gap-3 sm:flex-row'>
                    <a className='border border-white w-full h-10 rounded-md flex justify-center items-center cursor-pointer font-semibold transition-colors ease-in-out hover:bg-white hover:text-black' href='https://github.com/BugReportOnWeb' target='_blank'><span><AiFillGithub className='mr-2 text-xl' /></span>GitHub</a>
                    <a className='border border-white w-full h-10 rounded-md flex justify-center items-center cursor-pointer font-semibold transition-colors ease-in-out hover:bg-white hover:text-black' href='https://twitter.com/devkaul0' target='_blank'><span><AiOutlineTwitter className='mr-2 text-xl' /></span>Twitter</a>
                </div>
            </div>
        </div>
    )
