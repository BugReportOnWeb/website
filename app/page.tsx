...
const Home = () => {
    return (
        <div className='h-full pt-24 sm:flex sm:justify-center sm:items-center sm:pt-5'>
            <div className='max-w-sm mx-auto flex flex-col px-3 pb-7 justify-center items-center gap-8 sm:flex-row-reverse sm:items-start sm:pb-0 sm:max-w-[40rem] sm:gap-5'>
