        ...
        <div className='max-w-md mx-auto flex flex-col px-3 pb-7 justify-center items-center gap-5 sm:flex-row-reverse sm:items-start sm:mt-0 sm:max-w-[40rem]'>
            ...
            <div className='sm:w-3/4'>
                <div className='flex flex-col gap-4'>
                    <p className='leading-8'>Hey there! I&apos;m Dev, a hobbyist developer from Shimla, HP. I love coding for fun, creating silly scripts and websites, diving into all the tech stuff before 2092. Apart from that, music is my true passion and brings me so much joy.</p>
                    <p className='leading-8'>Honestly, I don&apos;t know the exact purpose of all this, but take your time and feel free to check out my work and stuff. No pressure! :)</p>
                </div>
