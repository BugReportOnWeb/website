...
const Contact = () => {
    ...
    return (
        <div className='h-full pt-[6.75rem] sm:flex sm:justify-center sm:items-center sm:pt-5'>
            <div className='mx-auto flex pb-7 px-5 flex-col justify-center items-center w-fit gap-10'>
                <div className='flex items-start gap-5'>
                    <a href='https://te.me/devkaul' target='_blank' className='text-sm border border-[#242F2B] w-full px-5 py-3 rounded-md flex justify-center items-center cursor-pointer bg-transparent hover:bg-[#27272a]'><span><FaTelegramPlane className='mr-2 text-xl' /></span>Telegram</a>
                    <a href='#' className='text-sm border border-[#242F2B] w-full px-5 py-3 rounded-md flex justify-center items-center cursor-pointer bg-transparent hover:bg-[#27272a]'><span><BsFillChatDotsFill className='mr-2 text-xl' /></span>IRC</a>
                    <a href='#' className='text-sm border border-[#242F2B] w-full px-5 py-3 rounded-md flex justify-center items-center cursor-pointer bg-transparent hover:bg-[#27272a]'><span><FaDiscord className='mr-2 text-xl' /></span>Discord</a>
                </div>
