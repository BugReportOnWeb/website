const Footer = () => {
    return (
        <div className='absolute w-full -bottom-20 left-0 text-sm px-5 pb-6 flex flex-col gap-1 items-center sm:flex-row sm:justify-between sm:items-end sm:gap-0 sm:bottom-0'>
